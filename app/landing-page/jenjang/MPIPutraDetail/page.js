...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "MA&apos;HAD ALY PUTRA - MPI",
        text: "Informasi pendaftaran MA&apos;HAD ALY PUTRA - MPI",
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">MA&apos;HAD ALY PUTRA - MPI</span>
      </p>
  ...
  return (
    <div>
      ...
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">        
        <ProfileItem text="Menjadi Program Studi yang unggul dan inovatif dalam bidang Manajemen Pendidikan Islam pada Tahun 2034."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Misi</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Menyelenggarakan pendidikan dan pembelajaran yang berkualitas untuk mendukung terwujudnya lulusan yang unggul dan inovatif dalam bidang manajemen pendidikan Islam." />
        <ProfileItem text="Mengembangkan budaya penelitian dan publikasi ilmiah yang berkontribusi pada pengembangan keilmuan manajemen pendidikan Islam." />
        <ProfileItem text="Mengembangkan Pengabdian kepada Masyarakat dalam bidang Manajemen Pendidikan Islam." />
        <ProfileItem text="Meningkatkan kolaborasi tingkat nasional maupun internasional dengan berbagai pihak dalam bidang manajemen pendidikan Islam."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Tujuan</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Menghasilkan lulusan dengan kemampuan akademis yang unggul dan inovatif di bidang manajemen pendidikan Islam." />
        <ProfileItem text="Menghasilkan penelitian dan publikasi ilmiah yang berkontribusi bagi masyarakat dalam bidang manajemen pendidikan Islam." />
        <ProfileItem text="Menghasilkan karya pengabdian yang bermanfaat bagi masyarakat, terutama dalam penyelesaian problem-problem Manajemen Pendidikan Islam." />
        <ProfileItem text="Terwujudnya kolaborasi tingkat nasional maupun internasional dengan berbagai pihak dalam rangka pengembangan program Manajemen Pendidikan Islam secara global."/>           
      </div>
