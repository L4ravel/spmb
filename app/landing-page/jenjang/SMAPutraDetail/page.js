...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "SMA Islam As-Sunnah",
        text: "Informasi pendaftaran SMA Islam As-Sunnah",
              ...
              <div className="overflow-hidden rounded-3xl border border-violet-200 bg-white">
                ...
                <div className="space-y-4 p-5 sm:p-6">
                  ...
                  <InfoItem
                    ...
                    label="Kepala/Ketua"
                    value=" ZIYA SAFRONI, S.Pd"
                  />
                  <InfoItem
                    icon={<Phone className="h-5 w-5 text-green-600" />}
                    label="Wa/Telpon"
                    value="(+62) 877 6296 5609"
                  />
                </div>
              </div>
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">SMA ISLA AS-SUNNAH</span>
      </p>
  ...
  return (
    <div>
      ...
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        ...
        <ProfileItem text="Menghafal 5 Juz dan Bulughul Maram Kitab Shalat hingga Bab Sifat Shalat (175 hadits, 65/tahun)." />
        <ProfileItem text="Terampil berbahasa Arab lisan dan tulisan." />
        <ProfileItem text="Aktif berbahasa Inggris." />
        <ProfileItem text="Mencapai kriteria maksimum jenjang pendidikan atas." />
