...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "MA&apos;HAD ALY PUTRA - PGMI",
        text: "Informasi pendaftaran MA&apos;HAD ALY PUTRA - PGMI",
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">MA&apos;HAD ALY PUTRA - PGMI</span>
      </p>
  ...
  return (
    <div>
      ...
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">        
        <ProfileItem text="Menjadi program studi yang unggul dan inovatif dalam bidang pendidikan dasar berbasis keislaman tahun 2034."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Misi</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Mengembangkan pendidikan dan pembelajaran yang inovatif untuk menghasilkan lulusan yang profesional dan unggul dalam bidang pendidikan dasar berbasis keislaman." />
        <ProfileItem text="Mengembangkan penelitian dan publikasi ilmiah yang bermanfaat bagi pengembangan keilmuan dalam bidang pendidikan dasar berbasis keislaman." />
        <ProfileItem text="Meningkatkan peran serta civitas akademik dalam layanan pengabdian kepada masyarakat." />
        <ProfileItem text="Meningkatkan kerjasama nasional dan internasional dengan berbagai pihak di bidang pendidikan dasar berbasis keislaman."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Tujuan</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Meningkatkan lulusan yang inovatif, produktif, dan berdaya saing tinggi dalam bidang pendidikan dasar berbasis keislaman." />
        <ProfileItem text="Menghasilkan penelitian dan publikasi ilmiah yang berdayaguna bagi masyarakat dalam bidang pendidikan dasar berbasis keislaman." />
        <ProfileItem text="Menghasilkan karya pengabdian yang bermanfaat bagi masyarakat dalam bidang pendidikan dasar berbasis keislaman." />
        <ProfileItem text="Terwujudnya jalinan kerjasama yang baik secara nasional maupun internasional dalam rangka pengembangan program pendidikan dasar berbasis keislaman."/>           
      </div>
