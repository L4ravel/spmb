// components/ppdb/SMAPutraDetail.js
"use client";
...
export default function SMAPutraDetail() {
  const [activeTab, setActiveTab] = useState("persyaratan");

  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "PONDOK PESANTREN SALAFIYAH ULA.",
        text: "Informasi pendaftaran PONDOK PESANTREN SALAFIYAH ULA.",
          ...
          <div className="mb-4 flex items-center gap-3 sm:mb-6">
            ...
            <div className="min-w-0">
              <h1 className="text-3xl font-black text-white sm:text-4xl md:text-5xl">
                PONDOK PESANTREN SALAFIYAH ULA
              </h1>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 py-8 sm:py-10 md:py-12">
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8 min-w-0">
            ...
            {/* === NEW: Card Informasi LKSA / PPS (di atas Tabs) === */}
            <div className="mb-6 sm:mb-8 rounded-3xl border border-violet-200 bg-white p-5 sm:p-6 md:p-7 text-justify">
              <h3 className="mb-3 text-lg font-extrabold text-slate-900">
                Sekilas LKSA Islam Assunnah & PPS. Assunnah
              </h3>
              <p className="text-sm leading-relaxed text-slate-700">
                LKSA Islam Assunnah adalah Lembaga Kesejahteraan Sosial Anak berbasis Pesantren
                yang menyelenggarakan sekolah gratis bagi para Yatim, Piatu, Dhuafa dengan sistem
                pendidikan pondok pesantren salafiyah Assunnah (PPS. Assunnah).
              </p>
              <p className="mt-3 text-sm leading-relaxed text-slate-700">
                PPS. Assunnah adalah Pendidikan Pesantren berbasis kitab kuning yang diselenggarakan
                secara berjenjang dan terstruktur pada jalur pendidikan formal bernaung di bawah
                Kementerian Agama Republik Indonesia. Terdapat 2 (dua) jenjang pendidikan yaitu:
                <span className="font-semibold"> Wustha</span> setingkat SMP/MTs dan
                <span className="font-semibold"> Ulya</span> setingkat SMA/MA yang telah
            ...
            <div className="space-y-6 lg:sticky lg:top-24">
              ...
              <div className="overflow-hidden rounded-3xl border border-violet-200 bg-white">
                ...
                <div className="space-y-4 p-5 sm:p-6">
                  <InfoItem icon={<Award className="h-5 w-5 text-amber-500" />} label="Akreditasi: -" />
                  <InfoItem
                    icon={<User className="h-5 w-5 text-violet-600" />}
                    label="Kepala/Ketua"
                    value="MAHMUT DIANTO, S.Pd"
                  />
                  <InfoItem
                    icon={<Phone className="h-5 w-5 text-green-600" />}
                    label="Wa/Telpon"
                    value="(+62) 819 1766 2258"
                  />
                </div>
              </div>
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">PONDOK PESANTREN SALAFIYAH ULA.</span>
      </p>
          ...
          <RequirementItem
            text={
              <>
                ...
                <span className="font-bold text-violet-600">Rp 300.000</span>
              </>
            }
          />
      ...
      <div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <DocumentItem text="KTP Wali ( Uploud Dokumen )" />
          <DocumentItem text="Suket Meninggal Ayah ( Uploud Dokumen )" />
          <DocumentItem text="Suket Keterangan Tidak Mampu ( Uploud Dokumen )" />
          <DocumentItem text="Nomor PKH/DTKS ( Uploud Dokumen )" />
        </div>
      </div>
    </div>
  );
        ...
        <table className="w-full min-w-[560px]">
          ...
          <tbody className="divide-y divide-slate-100">
            <tr className="transition-colors hover:bg-violet-50/50">
              ...
              <td className="px-4 py-3 text-right font-semibold text-slate-900 sm:px-6 sm:py-4">0</td>
            </tr>
            <tr className="transition-colors hover:bg-violet-50/50">
  ...
  return (
    <div>
      ...
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Memahami dan mengamalkan aqidah dan manhaj ahlussunnah wal jamaah." />
        <ProfileItem text="Memahami dan mengamalkan ibadah sesuai sunnah." />
        <ProfileItem text="Memahami dan mengamalkan akhlaq mulia sesuai sunnah." />
        <ProfileItem text="Menghafal 20 Juz." />
        <ProfileItem text="Terampil berbahasa Arab lisan dan tulisan." />
        <ProfileItem text="Aktif berbahasa Inggris." />
        <ProfileItem text="Mencapai kriteria Standar Pendidikan Nasional." />
        <ProfileItem text="Mampu mengoperasikan MS Word, Excel, dan PowerPoint." />
        <ProfileItem text="Kompetitif dalam seleksi masuk perguruan tinggi di dalam dan luar negeri." />
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Ekstrakurikuler</h2>
      <div className="grid gap-3 sm:grid-cols-2">
        <EkstrakurikulerItem text="Tilawatil Quran" />
        <EkstrakurikulerItem text="Latihan Pidato 3 Bahasa" />
        <EkstrakurikulerItem text="Majalah Dinding" />
        <EkstrakurikulerItem text="English Camp" />
        <EkstrakurikulerItem text="Perlombaan Didalam dan Luar Sekolah" />
        <EkstrakurikulerItem text="Pondok IT" />
        <EkstrakurikulerItem text="Study Tour" />
        <EkstrakurikulerItem text="Pencak Silat" />
        <EkstrakurikulerItem text="Las listrik" />
        <EkstrakurikulerItem text="Futsal" />
      </div>
    </div>
  );
}
