...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "MA&apos;HAD ALY PUTRI - MPI",
        text: "Informasi pendaftaran MA&apos;HAD ALY PUTRI - MPI",
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">MA&apos;HAD ALY PUTRI - MPI</span>
      </p>
