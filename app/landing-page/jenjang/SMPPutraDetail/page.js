...
export default function SMPPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "SMP Islam As-Sunnah",
        text: "Informasi pendaftaran SMP Islam As-Sunnah",
            ...
            <div className="space-y-6 lg:sticky lg:top-24">
              ...
              <div className="overflow-hidden rounded-3xl border border-violet-200 bg-white">
                ...
                <div className="space-y-4 p-5 sm:p-6">
                  <InfoItem icon={<Award className="h-5 w-5 text-amber-500" />} label="Akreditasi: B" />
                  <InfoItem
                    icon={<User className="h-5 w-5 text-violet-600" />}
                    label="Kepala/Ketua"
                    value="HERJAN PANDI KUSNADI, S.Pd"
                  />
                  <InfoItem
                    icon={<Phone className="h-5 w-5 text-green-600" />}
                    label="Wa/Telpon"
                    value="(+62) 819 1813 0473"
                  />
                </div>
              </div>
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">SMP Islam As-Sunnah</span>
      </p>
