...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "PONDOK PESANTREN SALAFIYAH WUSTHO",
        text: "Informasi pendaftaran PONDOK PESANTREN SALAFIYAH WUSTHO",
          ...
          <div className="mb-4 flex items-center gap-3 sm:mb-6">
            ...
            <div className="min-w-0">
              <h1 className="text-3xl font-black text-white sm:text-4xl md:text-5xl">
                PONDOK PESANTREN SALAFIYAH WUSTHO
              </h1>              
            </div>
          </div>
        </div>
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">PONDOK PESANTREN SALAFIYAH WUSTHO.</span>
      </p>
