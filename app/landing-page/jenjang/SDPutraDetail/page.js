// components/ppdb/SDPutraDetail.js
"use client";
...
export default function SDPutraDetail() {
  const [activeTab, setActiveTab] = useState("persyaratan");

  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "SD Islam As-Sunnah",
        text: "Informasi pendaftaran SD Islam As-Sunnah",
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">SD ISLAM AS-SUNNAH</span>
      </p>
  ...
  return (
    <div>
      ...
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Mengenal biografi ringkas Nabi Muhammad dan Khulafa Arrasyidin." />
        <ProfileItem text="Memahami dan mengamalkan dasar-dasar aqidah ahlussunnah wal jamaah." />
        <ProfileItem text="Memahami dan mengamalkan dasar-dasar ibadah sesuai sunnah." />
        <ProfileItem text="Memahami dan mengamalkan dasar-dasar akhlaq mulia sesuai sunnah." />
        <ProfileItem text="Menghafal 3 Juz dan 42 Hadits Arbain Nawawi." />
        <ProfileItem text="Berani berbahasa Arab." />
        <ProfileItem text="Mengenal kosa kata dasar bahasa Inggris." />
        <ProfileItem text="Mencapai kriteria maksimum jenjang pendidikan dasar." />
        <ProfileItem text="Mampu mengoperasikan MS Word." />
        <ProfileItem text="Kompetitif dalam seleksi masuk SD unggulan." />
      </div>      
    </div>
  );
}
