...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "MA&apos;HAD ALY PUTRI - PGMI",
        text: "Informasi pendaftaran MA&apos;HAD ALY PUTRI - PGMI",
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">MA&apos;HAD ALY PUTRI - PGMI</span>
      </p>
