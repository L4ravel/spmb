// components/ppdb/TKPutraDetail.js
"use client";
...
export default function TKPutraDetail() {
  const [activeTab, setActiveTab] = useState("persyaratan");

  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "TK Islam As-Sunnah",
        text: "Informasi pendaftaran TK Islam As-Sunnah",
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">TK ISLAM AS-SUNNAH</span>
      </p>
  ...
  return (
    <div>
      ...
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Mengenal biografi ringkas Nabi Muhammad صلى الله عليه وسلم." />
        <ProfileItem text="Mengenal dan mengamalkan dasar-dasar aqidah ahlussunnah wal jamaah."/>
        <ProfileItem text="Mengenal dan mengamalkan dasar ibadah sesuai sunnah." />
        <ProfileItem text="Mengenal dan mengamalkan dasar-dasar akhlaq mulia sesuai sunnah." />
        <ProfileItem text="Menghafal setengah Juz (juz 30) hingga surah At-thoriq dan 13 hadits pendek." />
        <ProfileItem text="Mengenal kosa kata Bahasa Arab." />
        <ProfileItem text="Mengenal dasar literasi dan numerasi latin dan Arab (Iqro’ 6)." />
