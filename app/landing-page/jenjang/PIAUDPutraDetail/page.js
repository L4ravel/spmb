...
export default function SMAPutraDetail() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "MA&apos;HAD ALY PUTRA - PIAUD",
        text: "Informasi pendaftaran MA&apos;HAD ALY PUTRA - PIAUD",
          ...
          <div className="mb-4 flex items-center gap-3 sm:mb-6">
            ...
            <div className="min-w-0">
              <h1 className="text-3xl font-black text-white sm:text-4xl md:text-5xl">
                MA&apos;HAD ALY PUTRA - PIAUD
              </h1>
              <p className="mt-0.5 text-base text-slate-300 sm:mt-1">Program Putra</p>
            </div>
          </div>
        </div>
      </section>
  ...
  return (
    <div>
      <p className="mb-6 text-slate-600">
        ...
        <span className="font-bold text-slate-900">MA&apos;HAD ALY PUTRA - PIAUD</span>
      </p>
          ...
          <RequirementItem
            text={
              <>
                ...
                <span className="font-bold text-violet-600">Rp 400.000</span>
              </>
            }
          />          
...
function Profil() {
  return (
    <div>
      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Visi</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">        
        <ProfileItem text="Menjadi program studi yang unggul dan inovatif di bidang Pendidikan Islam Anak Usia Dini pada tahun 2034."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Misi</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Mengembangkan pendidikan dan pembelajaran yang inovatif untuk menghasilkan lulusan yang profesional dan unggul dalam bidang Pendidikan Islam Anak Usia Dini." />
        <ProfileItem text="Mengembangkan penelitian dan publikasi ilmiah yang bermanfaat bagi pengembangan keilmuan dalam bidang Pendidikan Islam Anak Usia Dini." />
        <ProfileItem text="Menyelenggarakan pengabdian kepada masyarakat untuk pengembangan dan penerapan inovasi di bidang Pendidikan Islam Anak Usia Dini." />
        <ProfileItem text="Meningkatkan kerjasama nasional dan internasional dengan berbagai pihak di bidang Pendidikan Islam Anak Usia Dini."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Tujuan</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Meningkatkan lulusan yang inovatif, produktif, dan berdaya saing tinggi dalam bidang pendidikan Islam anak usia dini." />
        <ProfileItem text="Menghasilkan penelitian dan publikasi ilmiah yang berdayaguna bagi masyarakat dalam bidang pendidikan Islam anak usia dini." />
        <ProfileItem text="Menghasilkan karya inovasi pengabdian yang bermanfaat bagi masyarakat dalam bidang pendidikan Islam anak usia dini." />
        <ProfileItem text="Terwujudnya jalinan kerjasama yang baik secara nasional maupun internasional dalam rangka pengembangan keilmuan Pendidikan Islam Anak Usia Dini."/>           
      </div>

      <h2 className="mb-5 text-xl font-black text-slate-900 sm:mb-6 sm:text-2xl">Target</h2>
      <div className="mb-8 space-y-3 sm:mb-10 sm:space-y-3.5">
        <ProfileItem text="Mencintai Allah dan Rasul-Nya." />
        <ProfileItem text="Beraqidah dan Bermanhaj Salaf Ahlussunnah Wal Jamaah, Mengamalkan Ilmu dan Berakhlaq Mulia." />
        <ProfileItem text="Melaksanakan Praktek Ibadah Sesuai Sunnah." />
        <ProfileItem text="Menghafal, Memahami, dan Mengamalkan Al Qur&apos;an." />
        <ProfileItem text="Menguasai Bahasa Arab dan Bahasa Inggris." />
        <ProfileItem text="Melanjutkan Pendidikan ke Jenjang Perguruan Tinggi Dalam dan Luar Negeri" />        
      </div>
    </div>
  );
}
